...
```    
即可以使用。mybatis 版本与 flying 版本的对应关系见下：

mybatis `3.2.6` `3.2.7` `3.2.8` 对应 flying `0.7.2`

mybatis `3.3.0` `3.3.1` 对应 flying `0.8.0`

mybatis `3.4.0` `3.4.1` `3.4.2` `3.4.3` `3.4.4` `3.4.5` 对应 `0.9.0`
